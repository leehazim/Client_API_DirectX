...
public:
	virtual void OnCreate() override {
		...
		pAnimEnemy->AddAniSeq("ani_idle_enemy", 0.2f, 7, L"resources/paladin_idle");
		pAnimEnemy->AddAniSeq("ani_attack_enemy", 0.2f, 10, L"resources/paladin_attack", ANI_INFO::ONCE);
		m_PFEnemy->GetAnimator()->SetPrevKey("ani_idle_enemy");
		m_PFEnemy->GetAnimator()->SetKey("ani_attack_enemy");
	...
	virtual void OnUpdate(float deltaTime) override {
		...
		if (m_pEnemy->m_TimeTick >= timer) {
			//TODO: Test
			m_pEnemy->GetAnimator()->SetPrevKey("ani_idle_enemy");
			m_pEnemy->GetAnimator()->SetKey("ani_attack_enemy");
			m_pEnemy->GetAnimator()->GetAniSeq()->SetCurIndex(0);
			m_pEnemy->GetAnimator()->GetAniSeq()->SetAniTime(0.0f);
